    ...
    def __call__(
        ...
        if (not cross_attn) or (
            ...
            with torch.backends.cuda.sdp_kernel(
                enable_flash=enable_flash_attn, enable_math=True, enable_mem_efficient=enable_flash_attn
            ):
        ...
        if attn_process_fn is not None and cross_attn:
            ...
            attention_probs = attn_process_fn(
                attention_probs,
                query,
                key,
                value,
        ...
        if return_attntion_probs or save_attn_to_dict is not None:
            ...
            attention_probs_unflattened = attention_probs_before_process.unflatten(
                dim=0, sizes=(batch_size, attn.heads)
            )
