...
# from diffusers.utils import maybe_allow_in_graph      #### NEWER VERSION
...
class GatedSelfAttentionDense(nn.Module):
    ...
    def forward(self, x, objs, fuser_attn_kwargs={}):
        ...
        x = (
            ...
            * self.attn(self.norm1(torch.cat([x, objs], dim=1)), **fuser_attn_kwargs)[:, :n_visual, :]
        )
    ...
    def forward(
        ...
        if gligen_kwargs is not None:
            ...
            hidden_states = self.fuser(
                hidden_states, gligen_kwargs["objs"], fuser_attn_kwargs=gligen_kwargs.get("fuser_attn_kwargs", {})
            )
        # 1.5 ends
